---
title: How to use Datama Assess (Light) in Excel
layout: new-page
scope: Datama/light
keywords: Excel assess get started
---

<br/>

> Using Datama Assess as a Excel extension is a great way to make your report more insightful with the benefits of both.
...
7. [Excel examples](#7-looker-studio-guide)
...
# 1. Overview
This document provides detailed documentation for the "Datama Assess" plugin, a powerful extension for Excel. This plugin enhances data analysis capabilities by detecting anomalies in KPI trends.
...
In order to use Datama in your report, you need to start create an account in [app.datama.io](app.datama.io) and go to "My account" then "Extensions" and copy the path from the Excel extension. 

<!-- <center><img style="width:60%;" src="{{site.url}}/{{site.baseurl}}/extensions/assets/gif/CopyPath_lookerstudio.png" /></center> -->


And then, follow these steps to add Datama in your Excel report : 
...
**4. [Paid user only] Save settings**: Once you are happy with your settings, in the Excel side panel, in the "Style" tab, paste the JSON automatically added to your clipboard in the "Config JSON" field. 
...
**5. [Paid user only] Leave edit mode**: In the Excel side panel, in the "Style" tab, untick the "Edit mode" toggle. Dashboard viewers won't see the top header and footer anymore, for a smoother experience. 
...
Following this [link](https://lookerstudio.google.com/u/0/reporting/0cdd7495-3b19-4ead-9a28-2f03f3a06835/page/p_febrf8vygd) you can access live demo of the extension on a real Excel. Don't hesitate to play with the extension with your own data. This is a free trial version with limited access. 

You can also see the demo [here](https://dataguillaume.gumroad.com/l/zkwemf) with Datama Compare and other available extensions in Excel connected to Google Analaytics source.

If you're using Google Ads as a data source in Excel, you can use this [template](https://dataguillaume.gumroad.com/l/fevwkj) right away.

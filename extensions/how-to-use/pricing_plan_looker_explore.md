---
title: Pricing plan of Datama Explore in Looker studio
layout: new-page
...
**Features include:**
- **All analysis and visualization features** described in Datama Explore extension documentation

The Free Trial version is ideal for small teams who don't mind Datama's branding and what to explore different features of Datama extensions in Looker studio.
...
- **All analysis and visualization features** described in the Datama Explore extension in Looker Studio documentation
- **Avoid Ads and Disclaimer**: Your extension will be free from Ads and Datama logo, you can hide header and footer.
- **Share with viewers**: Allow members of your organisation to view Datama's widget in their browser on published workbooks, without a looker studio builder licence

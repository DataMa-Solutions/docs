---
title: How to use Datama Explore (Light) in Power BI
layout: new-page
scope: Datama/light
keywords: Power BI assess get started
---

<br/>

> Using Datama Explore as a Power BI extension is a great way to make your report more insightful with the benefits of both.

<br/>

# 1. Overview
This document provides detailed documentation for the "Datama Exlore" plugin, a powerful extension for Power BI. This plugin enhances data analysis capabilities by breaking down any KPI or sub KPI by any dimension in your dataset.

Below is a short intro video
<br/>

<iframe width="560" height="315" src="https://www.youtube.com/embed/zDPd_XCmgBo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
1. Choose the Datama explore from the list provided on your account on app.datama.io and click on download it.
2. In the PowerBI visualization pane, click on the ellipsis ("...") to import a custom visual.
3. Select "Import a custom visual" and uplod the downloaded extension.
4. The visual will now appear as a new icon in the visualization pane. Click on it to create the visual on the report canvas.
  ...
  <img src="{{site.url}}/{{site.baseurl}}/extensions/assets/explore_powerBI_extension.png" align="center" width="650px" />

  <img src="{{site.url}}/{{site.baseurl}}/extensions/assets/gif/upload_explore_powerbi.gif" align="center" width="650px" />  
...
See [here]({{site.url}}/{{site.baseurl}}/extensions/how-to-use/pricing_plan_powerbi_explore.html) our different plans.
...
<center><img style="width:60%;" src="{{site.url}}/{{site.baseurl}}/extensions/assets/gif/Explore_PowerBI_Intro_Large.gif" /></center>

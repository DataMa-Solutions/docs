---
feed: totw_fr
title:  "Tip of the week 189: La nouvelle waterfall Datama Compare est arrivée"
date:   2026-09-01 08:00:00 +0200
img_url: /assets/images/tip/189.gif
img_type: image/gif
img_width: 800
img_height: 450
layout: post
...
**Datama Compare vient de passer un cap** — et l’analyse en waterfall ne sera plus la même 🚀
...
* **Infinite Drill down** — explorez par **dimension** ou par **étape**, aussi profond que vos données le permettent, avec des barres qui se transforment en place et un commentaire qui suit chaque split
...
* **Un seul workspace** — Waterfall, Table, Tree et Comment côte à côte ; chaque survol et chaque 'drill down' restent synchronisés
...
📖 [Découvrir toutes les nouveautés]({{site.url}}/{{site.baseurl}}/extensions/datama-compare/2026-feature.html)

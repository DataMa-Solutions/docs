...
![moves]({{site.url}}/{{site.baseurl}}/core_app/old/compare/web_application/dashboard/detailed_view/images/Compare-Moves.png)
...
![moves2]({{site.url}}/{{site.baseurl}}/core_app/old/compare/web_application/dashboard/detailed_view/images/Moves2-1024x525.png)

...
<center><img src="{{site.url}}/{{site.baseurl}}/core_app/old/header/input/images/SourceDimensionMetrics.jpg"/></center>
...
If a dimension is continuous (i.e. numeric) and has more than 6 possible values, it will get discrete by a partition algorithm, in order to be able to compute mix effects & performance. See [Clustering]({{site.url}}/{{site.baseurl}}/core_app/old/pivot/web_application/dashboard/clustering.md) methodology.

...
![Extract-PowerBI2]({{site.url}}/{{site.baseurl}}/core_app/old/header/export_results/images/Extract-PowerBI-Compare_GIF2.gif)
...
![PowerBI-switch]({{site.url}}/{{site.baseurl}}/core_app/old/header/export_results/images/PowerBI-switch-source.gif)

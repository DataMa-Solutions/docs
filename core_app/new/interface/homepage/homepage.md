...
- **Color Palette for Plots**:  
  Choose from **Grayscale, Scattered, or Custom**.  
  The **Custom** option lets you manually define colors for each graph.

<center><img src="{{site.url}}/{{site.baseurl}}/core_app/new/interface/subheader/settings/images/colors_palette.png"/></center>

**Customization Steps:**
1. Select **"Custom"** in *Colors Palette for Plots*.
2. Click the palette to **edit colors**.
3. Select the graph you want to modify.
4. Choose a new color by clicking on a graph section.
...
<center><img style="width:40%;" src="{{site.url}}/{{site.baseurl}}/core_app/new/interface/homepage/images/workbooks_management.png"/></center>

**Managing Workbooks**
- **Recent Section**: Displays recently accessed workbooks.  
  - Edit, delete, or move workbooks using the contextual menu.
- **Workbooks Page**: Provides an overview of all your workbooks.
...
2. Choose to open **advanced settings** or compute directly in **Compare**.

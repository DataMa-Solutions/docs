...
Create an organization, update its profile (name and avatar), review active subscriptions, manage team members (invite, admin role, selective removal), and delete the organization when needed.

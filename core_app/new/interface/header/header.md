...
<div class="info-box">
<strong>Note</strong>: Datama allows you to create several views in the same workbook based on the same data prep setting. Read our tip of the week 137 "New Views feature!" (Ctrl+F 137 on  <a href="https://datama-solutions.github.io//docs/tip_of_the_week.html" target="_blank">tips page</a>) to know more.
</div>

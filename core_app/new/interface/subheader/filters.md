---
title: Filters available on every solutions
...
> Find here how you can use **Filters** available on the subheader of the different solutions.

<br>

The filters menu is composed of 2 main options for each dimension of your dataset:
- Filter some segments in the analysis with one or multiple segments from one or multiple dimensions
- Exclude some dimensions/segments from the explanatory factors.

<br>

<center><img style="width:70%;" src="{{site.url}}/{{site.baseurl}}/core_app/new/interface/subheader/images/filter_new.png"/></center>

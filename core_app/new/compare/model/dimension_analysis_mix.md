...
<center> <img style="width:80%;" src="{{site.url}}/{{site.baseurl}}/core_app/new/compare/model/images/compare_mixEffectWF.png"></center>


<center> <img style="width:80%;" src="{{site.url}}/{{site.baseurl}}/core_app/new/compare/model/images/Mix-effect-dash.png"></center>


<!-- ![mix_effect]({{site.url}}/{{site.baseurl}}/core_app/new/compare/model/images/Mix-effect-dash.png) -->

# 2. Model of Mix effect
...
<div class="info-box">
In another way, Mix effect is the impact due to the change of proportion in entrance.</div>
